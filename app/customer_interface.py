...
def deposit_cash():
    ...
    with open(transaction_filename, "a") as file3:
        balance = str(balance)
...
def withdrawal_cash():
    withdrawn_amount = float(input("Please enter amount to bew withdrawn: "))
    username = input("Please enter username: ")
    filename = username + ".txt"
    transaction_filename = username + "_transactionhistory.txt"
    transaction_file = open(transaction_filename, "a")
...
if username in data and password in data:
    ...
    opt = int(
        input("Do you want to continue? Enter 0 to continue, 1 to terminate: ")
    )
    ...
    while True:
        if opt == 0:
            ...
            if opt == 1:
                ...
                opt = int(
                    input(
                        "Do you want to continue? Select 0 to continue, 1 to finish: "
                    )
                )
    ...
    print(
        "Incorrect Username or Password. Please try again later or contact our Customer Care Representative."
    )
